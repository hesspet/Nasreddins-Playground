param(
    [string]$RepositoryName = "TestSherpa",
...
$projectPath = Join-Path $projectRoot "TestSherpa.csproj"
...
# SPA-Fallback für GitHub Pages: Deep-Links (z.B. /TestSherpa/camera) werden von
