param(
    [string]$RepositoryName = "TestVosk",
...
$projectPath = Join-Path $projectRoot "TestVosk.csproj"
...
# SPA-Fallback für GitHub Pages: Deep-Links (z.B. /TestVosk/camera) werden von
